        ...
        {step === "form" && type && (
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {isLotCostTransaction(type) && <CurrencySelect rows={referenceData.currencies.filter((currency) => selectedLot?.countryCode === "PK" ? currency.code === "PKR" : ["PKR", "USD", "CNY", "AED", "AFN"].includes(currency.code))} value={form.currencyId} onChange={(currencyId) => setForm({ ...form, currencyId, sourceAccountId: "", intermediaryId: 0 })} />}
